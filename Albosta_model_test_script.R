...
#model to predict MPG for cars given its specifications

# set up
require (car) # for normal quantile plots
require(DAAG) # for vif

# Set up for plotting. We will be using two groups (engine types and transmission types)
...
#they look exactly the same, impling they are highly correlated, so throwing out am var for vs
